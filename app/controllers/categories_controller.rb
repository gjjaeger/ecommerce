class CategoriesController < ApplicationController
  ...
  def show
    ...
    if params[:id] == '2'
      ...
      lowPrice = params[:low]&&params[:currency] ? (Money.default_bank.exchange(params[:low], @currency, "SGD")).to_f : 0;
      highPrice = params[:high]&&params[:currency] ? (Money.default_bank.exchange(params[:high], @currency, "SGD")).to_f : 400;
